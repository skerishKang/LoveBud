(function() {
  ...
  window.i18nMyTrees = {
    ...
    'myTrees.page_title': { ko: '🌳 내가 키우는 러브트리', en: '🌳 My Growing LoveTrees' },
    ...
    'myTrees.manage_none': { ko: '열고 싶은 트리를 골라 보세요', en: 'Choose a tree to open' },
    'myTrees.manage_hint': { ko: '', en: '' },
    'myTrees.manage_open': { ko: '트리 열기', en: 'Open tree' },
    ...
    'myTrees.card_select': { ko: '트리 열기', en: 'Open tree' },
