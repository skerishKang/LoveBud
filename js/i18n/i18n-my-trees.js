(function() {
  ...
  window.i18nMyTrees = {
    ...
    'myTrees.manage_label': { ko: '지금 돌보는 트리', en: 'Tree you are tending now' },
    'myTrees.manage_none': { ko: '카드에서 트리를 하나 골라 보세요', en: 'Choose a tree from the cards' },
    'myTrees.manage_hint': { ko: '선택한 트리를 여기서 바로 이어가거나 다듬을 수 있어요.', en: 'You can continue or refine the selected tree here.' },
    'myTrees.manage_open': { ko: '이어보기', en: 'Continue' },
