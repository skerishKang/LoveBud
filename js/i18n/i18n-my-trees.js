(function() {
  ...
  window.i18nMyTrees = {
    ...
    'myTrees.page_desc': { ko: '내가 남긴 순간들을 다시 감상하고, 다음 장면을 이어가는 곳입니다.', en: 'A place to revisit the moments you saved and continue into the next scene.' },
    ...
    'myTrees.manage_label': { ko: '지금 바라보는 트리', en: 'Tree in view now' },
    'myTrees.manage_none': { ko: '카드에서 트리를 하나 골라 다시 열어보세요', en: 'Choose a tree from the cards and open it again' },
    'myTrees.manage_hint': { ko: '선택한 트리를 여기서 다시 열고, 이름이나 공개 범위를 다듬을 수 있어요.', en: 'Open the selected tree here, then refine its title or visibility.' },
    'myTrees.manage_open': { ko: '다시 열기', en: 'Open again' },
    'myTrees.manage_rename': { ko: '이름 다듬기', en: 'Refine title' },
    'myTrees.manage_delete': { ko: '삭제', en: 'Delete' },
    'myTrees.manage_visibility': { ko: '공개 범위', en: 'Visibility' },
    'myTrees.card_select': { ko: '고르기', en: 'Choose' },
    'myTrees.card_selected': { ko: '보고 있는 트리', en: 'Current tree' },
    'myTrees.card_open': { ko: '트리 열기', en: 'Open tree' },
    ...
    'myTrees.create_modal_desc': { ko: '제목과 공개 범위를 먼저 정하면, 곧바로 첫 순간을 남기러 이동해요.', en: 'Set a title and visibility first, then move straight into saving your first moment.' },
    'myTrees.create_modal_name_label': { ko: '트리 제목', en: 'Tree title' },
    'myTrees.create_modal_name_help': { ko: '나중에 다시 바꿀 수 있어요. 지금은 마음이 가장 먼저 가는 제목이면 충분해요.', en: 'You can rename it later. For now, the title your heart reaches for first is enough.' },
    'myTrees.create_modal_visibility_label': { ko: '공개 범위', en: 'Visibility' },
    'myTrees.create_modal_visibility_private': { ko: '비공개', en: 'Private' },
    'myTrees.create_modal_visibility_private_desc': { ko: '나만 보고 천천히 순간을 이어갈 수 있어요.', en: 'Only you can see it while you continue the moments at your own pace.' },
    'myTrees.create_modal_visibility_public': { ko: '공개', en: 'Public' },
    'myTrees.create_modal_visibility_public_desc': { ko: '다른 사람도 이 러브트리를 감상할 수 있게 열어둘 수 있어요.', en: 'You can open this LoveTree so others can view it too.' },
