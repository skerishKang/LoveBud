document.addEventListener('DOMContentLoaded', () => {
    ...
    const createEditorShellCopyApplier = ({ safeI18nText, i18n }) => {
        ...
        const textBindings = [
            ...
            ['detailEmptyTitle', 'detail_empty_title', '첫 순간을 기다리고 있어요'],
            ['detailEmptyDesc', 'detail_empty_desc', '가운데에서 첫 순간을 만들어보세요.'],
            ...
            ['detailCurrentMomentHint', 'editor_current_moment_hint', '메모를 확인하고 수정해보세요.'],
