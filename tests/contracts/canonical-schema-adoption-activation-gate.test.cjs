...
test('Hub Layout #4346 authority binding contract: manifest, allowlist, and profile parity', () => {
  ...
  // 6. Profile 4346 in operator-core has accepted fingerprint, ACTIVE_AUTHORIZED lifecycle, bound P3 comment 5543891263, bound P4 source activation 5545880541, and p4ExecutionAuthorized=true
  ...
  assert.equal(profile4346.p4ExecutionAuthorized, true);
  assert.equal(profile4346.activeAuthorizationComment, 5543891263);
  assert.equal(profile4346.p4SourceActivationComment, 5545880541);
});
