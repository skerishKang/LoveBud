...
export const SCOUT_LIVE_RATE_LIMIT_STORAGE_ADAPTER_CODES = Object.freeze({
  ...
  STORAGE_KV_SKELETON: 'STORAGE_KV_SKELETON',
...
const STORAGE_MODE_ALIASES = Object.freeze({
  ...
  kv_skeleton: SCOUT_LIVE_RATE_LIMIT_STORAGE_ADAPTER_MODES.KV_SKELETON,
...
const STORAGE_RUNTIME_SCAFFOLD_MODE_CODES = Object.freeze({
  ...
  [SCOUT_LIVE_RATE_LIMIT_STORAGE_ADAPTER_MODES.KV_SKELETON]: SCOUT_LIVE_RATE_LIMIT_STORAGE_ADAPTER_CODES.STORAGE_KV_SKELETON,
...
function getRuntimeScaffoldReason(mode) {
  ...
  if (mode === SCOUT_LIVE_RATE_LIMIT_STORAGE_ADAPTER_MODES.KV_SKELETON) {
    return 'Live rate-limit KV storage backend is a skeleton and disabled by default; no real storage is accessed.';
  }
...
function isRuntimeScaffoldMode(mode) {
  return mode === SCOUT_LIVE_RATE_LIMIT_STORAGE_ADAPTER_MODES.KV_DISABLED ||
    mode === SCOUT_LIVE_RATE_LIMIT_STORAGE_ADAPTER_MODES.KV_SKELETON ||
