...
export function createScoutLiveRateLimitStorageHashHelper(){return{disabled:true,sanitize:sanitizeHashPayload,hash:()=>({ok:false,disabled:true,code:DISABLED,hash:null,hashPreview:null})};}
