...
브라우저 기반 서비스에서는 다음 이유로 실도메인 검증이 필수입니다.
...
GitHub UI 검증 시 캡처 증빙을 활용하는 경������는 ���음과 같습니다.
...
### 8.3. screenshot-only Branch 분리 원칙
...
### 8.4. screenshot-only의 main 직접 Push 금지
