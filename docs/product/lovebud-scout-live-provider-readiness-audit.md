...
## Scout Live API-Key Language and Tone Contract (#2640)

- #2640 resolved by endpoint-level contract
- `requestedLanguage` / `desiredTone` preserved into provider prompt
- invalid values fallback to `ko` / `polite`
- prompt remains private and is not returned/logged
- #2636 actual staging smoke still required
