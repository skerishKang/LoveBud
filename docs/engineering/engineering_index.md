...
5. [JS_FILENAME_CONVENTION_AUDIT.md](./JS_FILENAME_CONVENTION_AUDIT.md) - #942 JS filename convention rename risk model, candidate areas, reference surfaces, and safe PR split
...
| [JS_FILENAME_CONVENTION_AUDIT.md](./JS_FILENAME_CONVENTION_AUDIT.md) | Issue #942 JS filename convention rename risk model, reference surfaces, candidate area classification, and follow-up PR split |
...
- JS filename convention cleanup은 `JS_FILENAME_CONVENTION_AUDIT.md`의 risk class, reference surfaces, and future PR split을 먼저 확인합니다.
