...
| [LEGACY_FIREBASE_AUTH_DOMAIN_ENV_POSTURE_DECISION.md](LEGACY_FIREBASE_AUTH_DOMAIN_ENV_POSTURE_DECISION.md) | Legacy Firebase authorized-domain and environment posture decision record for #545/#266 |
...
| [SECRET_OWNER_ROTATION_CADENCE_POLICY.md](SECRET_OWNER_ROTATION_CADENCE_POLICY.md) | Category-level secret owner, rotation cadence, emergency rotation, and evidence policy for #544/#266 |
