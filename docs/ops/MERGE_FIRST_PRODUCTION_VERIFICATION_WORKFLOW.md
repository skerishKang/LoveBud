...
7. **main의 정상 Production 배포** — Cloudflare Pages deploys main to Production.
8. **로그인된 Production에서 실제 화면 확인** — 컴1-브 performs post-merge Production verification with a logged-in real browser.
