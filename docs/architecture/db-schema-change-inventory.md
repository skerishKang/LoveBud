...
- The canonical migration stream (`db/migrations/`, `db/migration-provenance/*`) is reserved and inactive (`ADOPTION_REQUIRED`, empty). No historical application records are fabricated.
