...
- [RECENT_REFACTORING.md](./engineering/RECENT_REFACTORING.md) - 최근 코드 구조 정리 이력
 ...
 - [VIEWPORT_ORCHESTRATION_HOLD_DECISION.md](./engineering/VIEWPORT_ORCHESTRATION_HOLD_DECISION.md) - Viewport orchestration split 완료 및 constants/readableCenter hold 판단 문서
   ...
   - [lovebud-canonical-appreciation-boundary-audit.md](./engineering/lovebud-canonical-appreciation-boundary-audit.md) - #3475 docs-only Public Viewer vs Editor appreciation boundary audit: shared presentation candidates, permission/route matrices, #3075/#3188 social separation, #3487 state, implementation slices (no runtime)
